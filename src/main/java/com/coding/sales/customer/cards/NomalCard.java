...
public class NomalCard implements Card{
	public Double bBaseIntegral= BaseIntegral.oneAndeight;
	public String maxIntegral;
	public String minIntegral; 
	@Override
	public void setBaseIntegral() {
		this.bBaseIntegral = BaseIntegral.oneAndeight;
	}
	
	@Override
	public void setSumIntegral() {
		this.maxIntegral= SumIntegral.Integral_100000;
		this.minIntegral= SumIntegral.Integral_50000;
	}
